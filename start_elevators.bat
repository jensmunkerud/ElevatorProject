...
start "Elevator 15657" cmd /k "go run main.go -port 15657 -processpair"
start "Elevator 15658" cmd /k "go run main.go -port 15658 -processpair"
start "Elevator 15659" cmd /k "go run main.go -port 15659 -processpair"

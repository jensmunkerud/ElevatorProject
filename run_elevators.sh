...
# Start elevators
osascript -e 'tell application "Terminal" to do script "cd /Users/jensv/Desktop/ElevatorProject && go run main.go -port 15657"'
osascript -e 'tell application "Terminal" to do script "cd /Users/jensv/Desktop/ElevatorProject && go run main.go -port 15658"'
osascript -e 'tell application "Terminal" to do script "cd /Users/jensv/Desktop/ElevatorProject && go run main.go -port 15659"'